...
#define AIO_USERNAME "guillec03"
#define AIO_KEY "aio_lius98rdJuVB6DAMiwLDbS014iCL"
...
Adafruit_MQTT_Publish luz_temp = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/temperatura");
